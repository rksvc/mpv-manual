...
:   Default: no
    ...
    When <span class="title-ref">no</span>, other scripts printing text
    to the screen can overwrite the displayed stats. When
    <span class="title-ref">yes</span>, displayed stats are persistently
    shown for the respective duration. This can result in overlapping
...
:   Default: auto
    ...
    which is scaled with the window or kept at a constant size,
